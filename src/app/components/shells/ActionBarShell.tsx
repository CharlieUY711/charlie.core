...
export function ActionBarShell() {
  ...
  return (
    <div style={{
      ...
      padding: '0 28px', gap: 12, borderBottom: '1px solid #E9ECEF',
      ...
      {state.onSearch && (
        <div style={{
          ...
          height: BTN_HEIGHT, minWidth: 220, maxWidth: 340, flex: 1,
        }}>
      ...
      {state.buttons.map((btn, i) => (
        ...
        >
          {btn.icon && React.createElement(btn.icon, { size: 14 })}
          {btn.label}
        </button>
      ))}
    </div>
